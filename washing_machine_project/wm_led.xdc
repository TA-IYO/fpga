...
# Button
#set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports ctrl_but_up]
#set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports ctrl_but_down]
#set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports ctrl_but_left]
#set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports ctrl_but_right]
